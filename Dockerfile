...
RUN curl -L https://github.com/nfs-ganesha/nfs-ganesha/archive/V2.8.4.tar.gz | tar zx \
	  && curl -L https://github.com/nfs-ganesha/ntirpc/archive/v1.8.0.tar.gz | tar zx \
	  && rm -r nfs-ganesha-2.8.4/src/libntirpc \
	  && mv ntirpc-1.8.0 nfs-ganesha-2.8.4/src/libntirpc
WORKDIR /nfs-ganesha-2.8.4
